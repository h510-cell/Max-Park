...
def recivedMsg():
    ...
    while True:
        ...
        if(chunk in numbers and flashNumberLabel and not gameOver):
            ...
            canvas2.itemconfigure(flashNumberLabel,text = chunk,font=("Chalkbard SE",60))
        elif('wins the game.' in chunk):
            gameOver = True
            canvas2.itemconfigure(flashNumberLabel,text = chunk,font=("Chalkbard SE",40))
...
def askPlayerName():
    ...
    "Waiting for other to join...", font=("Chalkboard SE",30), fill="#3e2723")
